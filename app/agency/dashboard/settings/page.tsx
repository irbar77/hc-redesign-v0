                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex gap-2 mt-1.5">
                            <Input
                              ...
                              className="flex-1"
                            />
                            <Badge variant="outline" className="h-9 px-3 bg-primary/10 text-primary border-primary/20">
                    ...
                    <CardContent className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-sm text-muted-foreground">When someone applies to your job posting</p>
                        </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-sm text-muted-foreground">News, features, and promotional content</p>
                        </div>
                  ...
                  <Card className="border-primary/50 bg-primary/5">
                    ...
                    <CardContent className="space-y-4">
                      <div className="grid gap-4 sm:grid-cols-3">
                        ...
                        <div className="text-center p-4 bg-background rounded-lg border">
                          <p className="text-2xl font-bold">Unlimited</p>
                          <p className="text-sm text-muted-foreground">Team Broadcasts</p>
                        </div>
                      </div>
                      <div className="flex items-center justify-between pt-2">
                        <div>
                          <p className="text-sm text-muted-foreground">Next billing date</p>
                          <p className="font-medium">April 15, 2026</p>
                        </div>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      {twoFactorEnabled && (
                        <div className="p-4 bg-muted/50 rounded-lg">
                          <p className="text-sm text-muted-foreground">
                            Two-factor authentication is active. You will need to enter a code from your authenticator app when signing in.
                          </p>
                            ...
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                ...
                                <ul className="list-disc list-inside mt-2 space-y-1">
                                  ...
                                  <li>Team members and communications</li>
                                  <li>Billing history and credits</li>
                                  <li>All messages and favorites</li>
                                </ul>
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
